        ...
        {items.map(({ href, label, Icon }) => {
          ...
          return (
            <Link
              key={href}
              href={href}
              className={`flex flex-col items-center gap-1 rounded-xl py-2 text-[10px] font-medium leading-tight whitespace-nowrap transition ${
                active
